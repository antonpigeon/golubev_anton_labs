...
def draw_fence(surface: pygame.Surface, color: pygame.Color, rect: pygame.Rect,
    ...
    pygame.draw.line(surface, 'black', (rect[0], rect[1]), (rect[0] + rect[2], rect[1]))
    pygame.draw.line(surface, 'black', (rect[0], rect[1] + rect[3]), (rect[0] + rect[2], rect[1] + rect[3]))
    x = rect[0] + starting_x
...
# до этого места всё скопировано из 14_1
pygame.draw.rect(screen, 'lightblue', (0, 0, 600, 300))  # небо
pygame.draw.rect(screen, 'lightgreen', (0, 300, 600, 300))  # трава

draw_fence(screen, 'yellow', (100, 30, 500, 270), 30, 50, 5)
draw_fence(screen, 'yellow', (0, 150, 350, 150), 10, 20, 2)
draw_fence(screen, 'yellow', (300, 250, 300, 100), 20, 30, 3)
draw_fence(screen, 'yellow', (0, 270, 270, 130), 10, 30, 3)

draw_dog(screen, dog_color, (410, 330), 200, facing_left=False)

draw_doghouse(screen, 'red', 'yellow', (300, 300), 200)

draw_dog(screen, dog_color, (50, 360), 250, facing_left=True)
draw_dog(screen, dog_color, (50, 450), 200, facing_left=False)
draw_dog(screen, dog_color, (380, 450), 600)
